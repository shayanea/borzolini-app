    ...
    <SafeAreaView className="flex-1 bg-[#17171c]">
      ...
      >
        ...
        {isLoading && !pets ? (
          ...
          <View className="bg-[#1f1f24] rounded-xl p-8 items-center justify-center mt-8">
          ...
          <View className="space-y-4">
            {pets.map((pet) => (
              <TouchableOpacity
                key={pet.id}
                className="bg-[#1f1f24] rounded-xl p-4 flex-row items-center mb-4 shadow-sm"
              >
                <View className="w-16 h-16 bg-secondary-800 rounded-full items-center justify-center">
                  {pet.photo_url ? (
        ...
        <View className="bg-[#1f1f24] rounded-xl p-6 mt-6 shadow-sm">
          <Text className="text-lg font-semibold text-white mb-4">
            Health Log
          </Text>
          <Text className="text-secondary-400 mb-4">
            Track your pet's health records and medical history
          </Text>
          <TouchableOpacity className="bg-primary-500/20 px-4 py-3 rounded-lg">
            <Text className="text-primary-400 font-medium">View Health Log</Text>
          </TouchableOpacity>
        </View>

        {/* Skin Detection Entry Point */}
        <View className="bg-[#1f1f24] rounded-xl p-6 mt-4 shadow-sm">
